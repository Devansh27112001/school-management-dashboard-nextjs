...
// CLASS COLUMNS
export const ClassesColumns = (role: string) => {
  return [
    {
      header: "Class Name",
      accessor: "className",
...
export const EventsColumns = (role: string) => {
  return [
    {
      header: "Title",
      accessor: "title",
...
export const ExamsColumns = (role: string) => {
  return [
    {
      header: "Subject Name",
      accessor: "subjectName",
...
export const ParentsColumns = (role: string) => {
  return [
    {
      header: "Info",
      accessor: "info",
...
export const TeachersColumns = (role: string) => {
  return [
    {
      header: "Info",
      accessor: "info",
